...
<body>
  ...
  <a href="home.php"><button type="home" class="btn btn-outline-success mt-3">HOME</button></a>
</header>  
  ...
  <form class="mt-5 p-5" action ="demo.php" method="post">
     <div class="container" style="text-align: center; border: 2px solid red; padding: 40px;">
        ...
        <br>
          ...
          <div class="col-sm-3">
            <input type="number" name="Coffee" placeholder="0" max="3">
          </div>
          <div class="col-sm-3">
            10
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <input type="number" name="Boost" placeholder="0" max="3">
          </div>
          <div class="col-sm-3">
            10
          </div>
  ...
  <button type="submit" name="submit" class="btn btn-outline-primary mt-1">PLACE ORDER</button>
</footer> 
</form>   
</body>
</html>
